...
export const rawConfigPoblada = {
  ...
  fields: {
    ...
    GapsGiros: 'Panadería, Cafetería, Farmacia',
    AforoEstimado: 8000,
    CajonesEstacionamiento: 16,
    IngresoPromedioMXN: 35000,
    EdadMediana: 34,
    NucleosFamiliares: 12500,
    DensidadHabitantesKm2: 4200,
    FraccionamientosCercanos: 'Real Mayab\nEl Cielo\nResidencial Cumbres\n',
    AccesosDescripcion: 'Entrada y salida sobre Av. Huayacán con retorno cercano.',
    DemografiaFuente: 'INEGI 2020 + estimaciones Punch Marketing',
  },
};
